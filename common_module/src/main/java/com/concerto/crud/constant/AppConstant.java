package com.concerto.crud.constant;
...
public class AppConstant {
	...
	public static final String SQL_FORMAT = "SELECT * FROM %s%s WHERE %s";
	...
	public static final String DATASOURCE_NOT_NULL = "Datasource cannot be null";
	...
	public static final String COMMON_MODULE_NOT_FOUND = "Module not found";
}
